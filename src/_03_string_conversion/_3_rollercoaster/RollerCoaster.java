...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		...
		if( heightAsInt>= 48 ) {
			JOptionPane.showMessageDialog(null, "You are tall enough to ride by your self");
		}
		else if( heightAsInt>= 42 ) {
			JOptionPane.showMessageDialog(null, "You are tall enough to ride with someone else");
		}
		
		else {
			JOptionPane.showMessageDialog(null, "You must be taller than 42 inorder to ride");
		}
